var m=Object.defineProperty;var h=(l,t,e)=>t in l?m(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var s=(l,t,e)=>h(l,typeof t!="symbol"?t+"":t,e);function u(l){const t=[];let e=l;for(;e&&e!==document.body;){let i=e.tagName.toLowerCase();if(e.id){i=`#${e.id}`,t.unshift(i);break}if(e.className&&typeof e.className=="string"){const o=e.className.split(/\s+/).filter(a=>a&&!a.startsWith("jammin-")).slice(0,2);o.length>0&&(i+=`.${o.join(".")}`)}const n=e.parentElement;if(n){const o=Array.from(n.children).filter(a=>a.tagName===e.tagName);if(o.length>1){const a=o.indexOf(e)+1;i+=`:nth-child(${a})`}}t.unshift(i),e=e.parentElement}return t.join(" > ")}function p(l){const t=[];let e=l;for(;e&&e!==document.body;){let i=e.tagName.toLowerCase();if(e.id)i+=`#${e.id}`;else if(e.className&&typeof e.className=="string"){const n=e.className.split(/\s+/).filter(o=>o&&!o.startsWith("jammin-")).slice(0,2);n.length>0&&(i+=`.${n.join(".")}`)}if(t.unshift(i),e=e.parentElement,t.length>=4)break}return t.join(" > ")}class b{constructor(){s(this,"trackedElements",new Map);s(this,"config",null);s(this,"mutationObserver",null);s(this,"enabled",!1);s(this,"onDirtyChange",null);s(this,"selectionToolbar",null);this.handleInput=this.handleInput.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.handleSelectionChange=this.handleSelectionChange.bind(this),this.handleFormatCommand=this.handleFormatCommand.bind(this)}setConfig(t){this.config=t}setDirtyChangeHandler(t){this.onDirtyChange=t}enable(){this.enabled||!this.config||(this.enabled=!0,this.setupEditableElements(),this.createSelectionToolbar(),this.startObserving(),document.addEventListener("keydown",this.handleKeydown),document.addEventListener("selectionchange",this.handleSelectionChange))}disable(){this.enabled&&(this.enabled=!1,this.stopObserving(),this.removeAllEditable(),this.destroySelectionToolbar(),document.removeEventListener("keydown",this.handleKeydown),document.removeEventListener("selectionchange",this.handleSelectionChange))}isEnabled(){return this.enabled}setupEditableElements(){if(this.config)for(const t of this.config.editableSelectors)document.querySelectorAll(t).forEach(i=>this.makeEditable(i))}makeEditable(t){if(this.trackedElements.has(t))return;t.contentEditable="true",t.classList.add("jammin-editable");const e={element:t,originalContent:t.innerHTML,selector:u(t),elementPath:p(t),isDirty:!1};this.trackedElements.set(t,e),t.addEventListener("input",this.handleInput)}removeEditable(t){this.trackedElements.get(t)&&(t.contentEditable="false",t.classList.remove("jammin-editable","jammin-dirty"),t.removeEventListener("input",this.handleInput),this.trackedElements.delete(t))}removeAllEditable(){for(const[t]of this.trackedElements)this.removeEditable(t)}handleInput(t){const e=t.target,i=this.trackedElements.get(e);if(!i)return;const o=e.innerHTML!==i.originalContent;o!==i.isDirty&&(i.isDirty=o,e.classList.toggle("jammin-dirty",o),this.notifyDirtyChange())}handleKeydown(t){if((t.metaKey||t.ctrlKey)&&t.key==="s"&&this.hasDirtyElements()&&(t.preventDefault(),document.dispatchEvent(new CustomEvent("jammin:save"))),(t.metaKey||t.ctrlKey)&&this.isInEditableArea())switch(t.key.toLowerCase()){case"b":t.preventDefault(),this.execFormat("bold");break;case"i":t.preventDefault(),this.execFormat("italic");break;case"k":t.preventDefault(),this.promptAndCreateLink();break;case"7":t.preventDefault(),this.execFormat("insertOrderedList");break;case"8":t.preventDefault(),this.execFormat("insertUnorderedList");break}if(t.key==="Escape"){const e=document.activeElement;e&&this.trackedElements.has(e)&&(this.revertElement(e),e.blur())}}isInEditableArea(){var n,o;const t=window.getSelection();if(!t||t.isCollapsed)return!1;const e=t.anchorNode;return e?!!((o=(n=e.parentElement||e)==null?void 0:n.closest)==null?void 0:o.call(n,'[contenteditable="true"]')):!1}createSelectionToolbar(){if(this.selectionToolbar)return;const t=document.createElement("div");t.className="jammin-selection-toolbar",t.innerHTML=`
  ...
  `}class y{constructor(){s(this,"container",null);s(this,"shadowRoot",null);s(this,"expanded",!1);s(this,"outputExpanded",!1);s(this,"editEnabled",!1);s(this,"dirtyCount",0);s(this,"saving",!1);s(this,"config",null);s(this,"callbacks",null);s(this,"output","");s(this,"phase","idle");s(this,"filesChanged",[]);s(this,"error",null)}create(t,e){if(this.container)return;this.config=t,this.callbacks=e,this.container=document.createElement("div"),this.container.id="jammin-toolbar-container",this.shadowRoot=this.container.attachShadow({mode:"closed"});const i=document.createElement("style");i.textContent=g(),this.shadowRoot.appendChild(i);const n=document.createElement("div");n.className="jammin-toolbar",n.innerHTML=this.getToolbarHTML(),this.shadowRoot.appendChild(n),document.body.appendChild(this.container),this.setupEventListeners(),this.setExpanded(!1)}destroy(){this.container&&(this.container.remove(),this.container=null,this.shadowRoot=null)}getToolbarHTML(){var t;return`
    ...
    `}setupEventListeners(){if(!this.shadowRoot)return;const t=this.shadowRoot.querySelector(".jammin-toggle");t==null||t.addEventListener("click",()=>this.setExpanded(!this.expanded));const e=this.shadowRoot.querySelector(".jammin-close");e==null||e.addEventListener("click",()=>this.setExpanded(!1));const i=this.shadowRoot.querySelector("#jammin-edit-toggle");i==null||i.addEventListener("change",()=>{var r;this.editEnabled=i.checked,(r=this.callbacks)==null||r.onToggleEdit(this.editEnabled),this.updateUI()});const n=this.shadowRoot.querySelector("#jammin-save");n==null||n.addEventListener("click",()=>{var r;!this.saving&&this.dirtyCount>0&&((r=this.callbacks)==null||r.onSave())});const o=this.shadowRoot.querySelector("#jammin-revert");o==null||o.addEventListener("click",()=>{var r;this.dirtyCount>0&&((r=this.callbacks)==null||r.onRevert())});const a=this.shadowRoot.querySelector("#jammin-editor");a==null||a.addEventListener("click",()=>{var r;(r=this.callbacks)==null||r.onOpenEditor()});const d=this.shadowRoot.querySelector("#jammin-output-toggle");d==null||d.addEventListener("click",()=>{this.setOutputExpanded(!this.outputExpanded)});const c=this.shadowRoot.querySelector(".jammin-output-close");c==null||c.addEventListener("click",()=>{this.setOutputExpanded(!1)})}setExpanded(t){var n,o;this.expanded=t;const e=(n=this.shadowRoot)==null?void 0:n.querySelector(".jammin-panel-wrapper"),i=(o=this.shadowRoot)==null?void 0:o.querySelector(".jammin-toggle");t?(e==null||e.classList.add("expanded"),i==null||i.classList.add("hidden")):(e==null||e.classList.remove("expanded"),i==null||i.classList.remove("hidden"),this.setOutputExpanded(!1))}setOutputExpanded(t){var i;this.outputExpanded=t;const e=(i=this.shadowRoot)==null?void 0:i.querySelector(".jammin-output-drawer");t?e==null||e.classList.add("expanded"):e==null||e.classList.remove("expanded")}updateDirtyCount(t){this.dirtyCount=t,this.updateUI()}setSaving(t){this.saving=t,this.updateUI()}setStatus(t){var i;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("#jammin-status-message");e&&(e.textContent=t)}updateUI(){if(!this.shadowRoot)return;const t=this.shadowRoot.querySelector(".jammin-badge");t&&(t.style.display=this.dirtyCount>0?"flex":"none",t.textContent=String(this.dirtyCount));const e=this.shadowRoot.querySelector("#jammin-save");if(e){e.disabled=this.dirtyCount===0||this.saving;const o=e.querySelector("span");o&&(o.textContent=this.saving?"Saving...":"Save")}const i=this.shadowRoot.querySelector("#jammin-revert");i&&(i.disabled=this.dirtyCount===0||this.saving);const n=this.shadowRoot.querySelector("#jammin-edit-toggle");n&&n.checked!==this.editEnabled&&(n.checked=this.editEnabled),this.updateOutputUI()}updateOutputUI(){if(!this.shadowRoot)return;const t=this.shadowRoot.querySelector(".jammin-status-indicator"),e=this.shadowRoot.querySelector(".jammin-status-phase");if(t&&(t.className="jammin-status-indicator",this.phase!=="idle"&&t.classList.add(`phase-${this.phase}`),this.error&&t.classList.add("phase-error")),e)if(this.error)e.textContent="Error";else switch(this.phase){case"idle":e.textContent="Ready";break;case"thinking":e.textContent="Thinking...";break;case"editing":e.textContent="Editing files...";break;case"complete":e.textContent="Complete";break}const i=this.shadowRoot.querySelector(".jammin-output-content");if(i){const a=this.output.replace(/\x1b\[[0-9;]*m/g,"").replace(/\r/g,"");i.textContent=a||"Waiting for output..."}const n=this.shadowRoot.querySelector(".jammin-output-footer");n&&(this.filesChanged.length>0?n.innerHTML=`
          <div class="jammin-files-header">Files modified:</div>
          <ul class="jammin-files-list">
            ${this.filesChanged.map(a=>`<li>${this.escapeHtml(a)}</li>`).join("")}
          </ul>
        `:this.error?n.innerHTML=`<div class="jammin-error">${this.escapeHtml(this.error)}</div>`:n.innerHTML="");const o=this.shadowRoot.querySelector(".jammin-output-body");o&&(o.scrollTop=o.scrollHeight)}setEditEnabled(t){this.editEnabled=t,this.updateUI()}resetOutput(){this.output="",this.phase="thinking",this.filesChanged=[],this.error=null,this.updateOutputUI()}addProgress(t){this.output+=t.output,this.phase=t.phase,this.updateOutputUI()}setComplete(t){this.phase="complete",this.filesChanged=t.filesChanged||[],this.error=t.error||null,this.updateOutputUI()}showOutput(){this.setOutputExpanded(!0)}hideOutput(){this.setOutputExpanded(!1)}toggleOutput(){this.setOutputExpanded(!this.outputExpanded)}escapeHtml(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}}class v{constructor(){s(this,"config",null);s(this,"editor",null);s(this,"toolbar",null);s(this,"currentJobId",null);s(this,"styleElement",null);s(this,"activated",!1);s(this,"pendingChanges",null);chrome.runtime.onMessage.addListener((t,e,i)=>t.action==="activate_cms"?(this.activate().then(()=>{i({success:!0,activated:this.activated})}),!0):t.action==="cms_status"?(i({activated:this.activated}),!1):(this.activated&&this.handleBackgroundMessage(t),!1))}async activate(){if(this.activated)return;console.log("[Jammin] Activating — checking config for:",window.location.href,"| title:",document.title);const t=await this.getConfigForCurrentPage();if(!t){console.log("[Jammin] No matching config for this page");return}this.config=t,this.activated=!0,console.log("[Jammin] Activated for:",t.name,"| path:",t.localPath),this.editor=new b,this.toolbar=new y,this.injectPageStyles(),this.editor.setConfig(t),this.editor.setDirtyChangeHandler(()=>{var e,i;(i=this.toolbar)==null||i.updateDirtyCount(((e=this.editor)==null?void 0:e.getDirtyCount())||0)}),this.toolbar.create(t,{onSave:()=>this.handleSave(),onRevert:()=>this.handleRevert(),onToggleEdit:e=>this.handleToggleEdit(e),onOpenEditor:()=>this.handleOpenEditor()}),document.addEventListener("jammin:save",()=>this.handleSave())}async getConfigForCurrentPage(){return new Promise(t=>{chrome.runtime.sendMessage({action:"get_site_config",payload:{url:window.location.href,title:document.title}},e=>{t(e==null?void 0:e.payload)})})}injectPageStyles(){this.styleElement=document.createElement("style"),this.styleElement.id="jammin-page-styles",this.styleElement.textContent=f(),document.head.appendChild(this.styleElement)}handleToggleEdit(t){!this.editor||!this.toolbar||(t?(this.editor.enable(),document.body.classList.add("jammin-editing-active")):(this.editor.disable(),document.body.classList.remove("jammin-editing-active")),this.toolbar.setEditEnabled(t))}async handleSave(){if(!this.config||!this.editor||!this.toolbar||!this.editor.hasDirtyElements())return;const t=this.editor.getDirtyChanges();t.length!==0&&(console.log(`[Jammin] Saving ${t.length} change(s) to ${this.config.localPath}`),this.toolbar.setSaving(!0),this.toolbar.setStatus("Checking project..."),this.toolbar.resetOutput(),this.toolbar.showOutput(),this.pendingChanges={projectPath:this.config.localPath,siteUrl:window.location.href,changes:t,customInstructions:this.config.customInstructions},chrome.runtime.sendMessage({action:"submit_changes",payload:this.pendingChanges},e=>{var i,n,o;(e==null?void 0:e.action)==="job_accepted"?(this.currentJobId=e.payload.jobId,console.log(`[Jammin] Job accepted: ${this.currentJobId.slice(0,8)}`),(i=this.toolbar)==null||i.setStatus("Claude is working...")):(e==null?void 0:e.action)==="error"?(console.error("[Jammin] Submit error:",e.payload.message),(n=this.toolbar)==null||n.setSaving(!1),(o=this.toolbar)==null||o.setStatus("Error: "+e.payload.message),this.pendingChanges=null):console.warn("[Jammin] Unexpected submit response:",e)}))}handleRevert(){!this.editor||!this.toolbar||(this.editor.revertAll(),this.toolbar.setStatus("Changes reverted"))}handleOpenEditor(){this.config&&chrome.runtime.sendMessage({action:"open_editor",payload:{projectPath:this.config.localPath}})}handleBackgroundMessage(t){var e,i,n,o;if(!this.toolbar||!this.editor){console.warn("[Jammin] Received message but toolbar/editor not ready:",t.action);return}switch(t.action){case"job_progress":{const a=t.payload;a.jobId===this.currentJobId?(this.toolbar.addProgress(a),this.toolbar.setStatus(a.phase==="editing"?"Editing files...":"Claude is thinking...")):console.warn(`[Jammin] Progress for unknown job ${(e=a.jobId)==null?void 0:e.slice(0,8)}, current: ${(i=this.currentJobId)==null?void 0:i.slice(0,8)}`);break}case"job_complete":{const a=t.payload;if(a.jobId===this.currentJobId){if(console.log(`[Jammin] Job complete: success=${a.success}, files=${((n=a.filesChanged)==null?void 0:n.length)??0}`),this.toolbar.setComplete(a),this.toolbar.setSaving(!1),a.success){this.editor.markSaved();const d=((o=a.filesChanged)==null?void 0:o.length)||0;this.toolbar.setStatus(`Done! ${d} file${d!==1?"s":""} modified`)}else this.toolbar.setStatus("Error: "+(a.error||"Unknown error"));this.currentJobId=null}break}case"job_cancelled":{t.payload.jobId===this.currentJobId&&(this.toolbar.setSaving(!1),this.toolbar.setStatus("Cancelled"),this.currentJobId=null);break}case"git_dirty":{const a=t.payload;a.jobId===this.currentJobId&&this.handleGitDirty(a);break}case"error":{console.error("[Jammin] Error from background:",t.payload.message),this.toolbar.setSaving(!1),this.toolbar.setStatus("Error: "+t.payload.message);break}default:console.log("[Jammin] Unhandled message:",t.action)}}handleGitDirty(t){if(!this.toolbar)return;const e=t.changedFiles.length,i=t.changedFiles.slice(0,5).join(`
  `),n=e>5?`
  ... and ${e-5} more`:"";confirm(`This project has ${e} uncommitted change${e!==1?"s":""}:
  ${i}${n}

Do you want to proceed anyway?`)&&this.pendingChanges?chrome.runtime.sendMessage({action:"submit_changes_force",payload:this.pendingChanges},a=>{var d,c,r;(a==null?void 0:a.action)==="job_accepted"?(this.currentJobId=a.payload.jobId,(d=this.toolbar)==null||d.setStatus("Claude is working...")):(a==null?void 0:a.action)==="error"&&((c=this.toolbar)==null||c.setSaving(!1),(r=this.toolbar)==null||r.setStatus("Error: "+a.payload.message))}):(this.toolbar.setSaving(!1),this.toolbar.setStatus("Cancelled - uncommitted changes"),this.currentJobId=null),this.pendingChanges=null}}new v;
